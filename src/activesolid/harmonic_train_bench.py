...
def train():
    ...
    parser.add_argument('--Ne', type=int, default=3, help='Number of edges nodes.')
    ...
    parser.add_argument('--lr', type=float, default=1E3, help='Learning rate.')
    ...
    parser.add_argument('--angle', type=float, default=0, help='Voltage lagging phase angle.')
    ...
    parser.add_argument('--A', type=float, default=0.01, help='Amplitude of the deformation.')
